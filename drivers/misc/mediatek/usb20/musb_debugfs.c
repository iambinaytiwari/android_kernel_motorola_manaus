...
static const struct proc_ops musb_regdump_fops = {
	.proc_open = musb_regdump_open,
	.proc_read = seq_read,
...
static const struct proc_ops musb_test_mode_fops = {
	.proc_open = musb_test_mode_open,
	.proc_write = musb_test_mode_write,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
};
...
static const struct proc_ops musb_regw_fops = {
	.proc_open = musb_regw_open,
	.proc_write = musb_regw_mode_write,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
};
...
static const struct proc_ops musb_regr_fops = {
	.proc_open = musb_regr_open,
	.proc_write = musb_regr_mode_write,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
};
...
static const struct proc_ops musb_speed_fops = {
	.proc_open = musb_speed_open,
	.proc_write = musb_speed_write,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
};
...
/* while CONFIG_MTK_MUSB_DUAL_ROLE is configured
 * create attribute (vbus & mode) in proc/mtk_usb
 */
#if IS_ENABLED(CONFIG_MTK_MUSB_DUAL_ROLE)
				...
				size_t count, loff_t *ppos)
{
	...
	if (!strncmp(buf, "host", 4) && !musb->is_host) {
		...
		dev_info(musb->controller, "wrong or duplicated setting\n");
		return -EINVAL;
	}
...
static const struct proc_ops musb_mode_fops = {
	.proc_open = musb_mode_open,
	.proc_write = musb_mode_write,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
};
				...
				size_t count, loff_t *ppos)
{
	...
	if (kstrtobool(buf, &enable)) {
		dev_info(musb->controller, "wrong setting\n");
		return -EINVAL;
	}
...
static const struct proc_ops musb_vbus_fops = {
	.proc_open = musb_vbus_open,
	.proc_write = musb_vbus_write,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
};
...
#endif /* CONFIG_MTK_MUSB_DUAL_ROLE */
